        ...
        <div className='model-container'>
            <div className='bg-gray-900 text-center p-5 h-96 lg:w-[500px] rounded shadow-md'>
                ...
                <form className='px-4'>
                    ...
                    {/* email */}
                    <div className='mb-5'>
                        <input type='email' name='email' id='m-email' placeholder='example@gmail.com' 
                ...
                {/* model close button */}
                <button onClick={onClose} className='bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-8 rounded
